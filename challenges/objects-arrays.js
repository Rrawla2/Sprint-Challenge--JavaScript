...
unisWithUni = universities.filter(item => {
  if(item.includes('Uni'))
    return item;
})
console.log(`There are ${unisWithUni.length} Universities with 'Uni' in their name.`);
...
populationTotal = zooAnimals.reduce(function(sum, zooAnimals) {
